...
import com.example.jetpackcomposepaging3.domain.Beer
import com.example.jetpackcomposepaging3.ui.theme.JetpackComposePaging3Theme
...
fun BeerItemPreview(){
    JetpackComposePaging3Theme {
        BeerItem(beer = Beer(
            id = 1,
            name = "Beer",
            tagline = "This a cool beer",
            firstBrewed = "07/2023",
            description = "This a description for a beer. \n This is the next line.",
            imageUrl = null
